...
@Component({
  selector: 'app-venuecomment',
  templateUrl: './venuecomment.component.html',
  styleUrls: ['./venuecomment.component.scss']
})
export class VenuecommentComponent implements OnInit {
  ...
  open(outlet:any)
  {
    const vrurl = "/venuereview?id=" + outlet._id;
    console.log(vrurl)
