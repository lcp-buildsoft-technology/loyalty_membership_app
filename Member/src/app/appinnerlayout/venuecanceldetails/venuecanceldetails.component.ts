...
@Component({
  selector: 'app-venuecanceldetails',
  templateUrl: './venuecanceldetails.component.html',
  styleUrls: ['./venuecanceldetails.component.scss']
})
export class VenuecanceldetailsComponent implements OnInit {
