...
@Component({
  selector: 'app-rewardvoucherclaimed',
  templateUrl: './rewardvoucherclaimed.component.html',
  styleUrls: ['./rewardvoucherclaimed.component.scss']
})
export class RewardvoucherclaimedComponent implements OnInit {
  message: any;
  public id:any;
  dataToString:any;
  todayDate = "";
