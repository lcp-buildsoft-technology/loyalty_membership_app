...
@Component({
  selector: 'app-earnpointsclaimed',
  templateUrl: './earnpointsclaimed.component.html',
  styleUrls: ['./earnpointsclaimed.component.scss']
})
export class EarnpointsclaimedComponent implements OnInit {
  message: any;
  public id:any;
  dataToString:any;
  todayDate = "";
